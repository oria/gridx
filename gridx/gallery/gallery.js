require([
	...
	var packs = [
		['Core', [
			['Simplest Grid', 'test_grid', 'pure.png', 'The Simplest Grid.'],
		...
		['Plugins', [
			...
			['Drag & Drop - Drag rows from/to non-grid source', 'test_grid_dndrow_nongrid_source', 'dnd.jpg', 'Drag and drop grid rows between grid and non-grid sources.'],
			['Drag & Drop - Drag rows to non-grid targets', 'test_grid_dndrow_nongrid_target', 'dnd.jpg', 'Drag and drop grid rows to non-grid targets.'],
