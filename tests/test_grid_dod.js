require([
	...
	'dojo/domReady!'
			...
			focus, VirtualVScroller, Dod, SelectRow, extendedSelectRow,
			RowHeader, IndirectSelect, JulieTheme){
	...
	window.addRow = function(){
		window.grid.store.add(
		{
			...
			Length:"04:29",
			Track:2,
			Composer:"Steven J. Morse",
			"Download Date":"2035/8/13", "Last Played":"17:17:49"
		});
	};
	...
	tp.addTestSet('DoD types', [
		...
		'<div data-dojo-type="dijit.form.Button" data-dojo-props="onClick: addRow">Add Row</div>'
	].join(''));
